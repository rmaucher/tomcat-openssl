...
public final class TesterSupport {
    ...
    protected static void initSsl(Tomcat tomcat, String keystore,
        ...
        if (protocol.indexOf("Apr") == -1) {
            ...
            File keystoreFile =
                new File("test/ch/unibnf/mcs/tomcatopenssl/net/ssl/open/" + keystore);
            connector.setAttribute("keystoreFile",
                    keystoreFile.getAbsolutePath());
            File truststoreFile = new File(
                    "test/ch/unibnf/mcs/tomcatopenssl/net/ssl/open/ca.jks");
            ...
            File keystoreFile = new File(
                    "test/ch/unibnf/mcs/tomcatopenssl/net/ssl/open/localhost-cert.pem");
            tomcat.getConnector().setAttribute("SSLCertificateFile",
                    keystoreFile.getAbsolutePath());
            keystoreFile = new File(
                    "test/ch/unibnf/mcs/tomcatopenssl/net/ssl/open/localhost-key.pem");
    ...
    protected static KeyManager[] getUser1KeyManagers() throws Exception {
        ...
        kmf.init(getKeyStore("test/ch/unibnf/mcs/tomcatopenssl/net/ssl/open/user1.jks"),
    ...
    protected static TrustManager[] getTrustManagers() throws Exception {
        ...
        tmf.init(getKeyStore("test/ch/unibnf/mcs/tomcatopenssl/net/ssl/open/ca.jks"));
